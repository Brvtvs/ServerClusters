...
public interface NetworkChangeListener {
   ...
   * @param clusterId The id of the cluster that the server is a part of.
   ...
   */
  void onServerJoin(String serverId, String clusterId, String ip, int port);
   ...
   * @param clusterId The id of the cluster that the server is a part of.
   * @param ip The ip of the server shutting down.
   * @param port The port of the server shutting down.
   */
  void onServerWillShutdown(String serverId, String clusterId, String ip, int port);
   ...
   * @param clusterId The id of the cluster that the server is a part of.
   * @param ip The ip of the server that has become unresponsive.
   * @param port The port of the server that has become unresponsive.
   */
  void onServerUnresponsive(String serverId, String clusterId, String ip, int port);
